...
class QueryDslCustomerRepositoryTest {

    private lateinit var emf: EntityManagerFactory
    private lateinit var em: EntityManager
    private lateinit var repository: QueryDslCustomerRepository
    ...
    fun setup() {
        ...
        repository = QueryDslCustomerRepository(em)
    ...
    @Test
    fun `should save and find customer by id with QueryDSL`() {
        // Given
        ...
        println("✓ [QueryDSL] Customer saved and retrieved: ${found?.name}")
    }

    @Test
    fun `should find all customers with QueryDSL`() {
        // Given
        ...
        println("✓ [QueryDSL] Found ${all.size} customers")
    }

    @Test
    fun `should update customer with QueryDSL`() {
        // Given
        val customer = Customer(
            id = CustomerId(1L),
            name = "John Doe",
        ...
        println("✓ [QueryDSL] Customer updated: ${found?.name}")
    }

    @Test
    fun `should delete customer with QueryDSL`() {
        // Given
        val customer = Customer(
            id = CustomerId(1L),
            name = "John Doe",
        ...
        println("✓ [QueryDSL] Customer deleted successfully")
    }

    @Test
    fun `should find customers with high value orders using QueryDSL`() {
        // Given
        ...
        println("✓ [QueryDSL] Found ${customers.size} customers with high value orders")
