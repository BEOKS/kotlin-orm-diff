...
class QueryDslPaymentRepositoryTest {
    ...
    private lateinit var repository: QueryDslPaymentRepository
    ...
    fun setup() {
        ...
        repository = QueryDslPaymentRepository(em)
    ...
    @Test
    fun `should save and find payment by id with QueryDSL`() {
        // Given
        ...
        println("✓ [QueryDSL] Payment saved and retrieved: $${found?.amount} via ${found?.method}")
    }

    @Test
    fun `should calculate customer order statistics with QueryDSL`() {
        // Given
        ...
        println("✓ [QueryDSL] Customer order statistics:")
    ...
    @Test
    fun `should calculate payment method statistics with QueryDSL`() {
        // Given
        setupCompleteOrdersWithPayments()
        em.flush()
        ...
        println("✓ [QueryDSL] Payment method statistics:")
    ...
    @Test
    fun `should find failed payments with details using QueryDSL`() {
        // Given
        setupFailedPayments()
        em.flush()
        ...
        println("✓ [QueryDSL] Failed payments:")
    ...
    @Test
    fun `should find premium customers using UNION with QueryDSL`() {
        // Given
        ...
        println("✓ [QueryDSL] Premium customers (UNION of high-value and frequent payers):")
    ...
    private fun setupCompleteOrdersWithPayments() {
        val customerRepo = QueryDslCustomerRepository(em)
