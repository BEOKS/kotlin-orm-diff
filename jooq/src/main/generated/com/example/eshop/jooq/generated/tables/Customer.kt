...
import com.example.eshop.jooq.generated.keys.CONSTRAINT_5
...
open class Customer(
     ...
     */
    val ID: TableField<CustomerRecord, Long?> = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "")
     ...
     */
    val ADDRESS: TableField<CustomerRecord, String?> = createField(DSL.name("ADDRESS"), SQLDataType.VARCHAR(500).nullable(false), this, "")

    /**
     * The column <code>PUBLIC.CUSTOMER.REGISTERED_DATE</code>.
     */
    val REGISTERED_DATE: TableField<CustomerRecord, LocalDate?> = createField(DSL.name("REGISTERED_DATE"), SQLDataType.LOCALDATE.nullable(false), this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<CustomerRecord> = CONSTRAINT_5
    ...
    fun orders(): OrdersPath {
        if (!this::_orders.isInitialized)
            _orders = OrdersPath(this, null, CONSTRAINT_8B.inverseKey)
